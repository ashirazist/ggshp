...
```{r}
githubinstall("ashirazist/ggshp")
```
...
We don't know if we need to release the package to CRAN or not. So we are keeping it not release for future possible changes.  
